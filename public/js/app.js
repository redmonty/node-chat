...
var _jquery = __webpack_require__(142);
...
var socket = (0, _socket2.default)(); //init request from server to client
socket.on('connect', function () {
...
socket.on('newMessage', function (date) {
    //client take from server
    var li = (0, _jquery2.default)('<li></li>');
    var formatedTime = (0, _moment2.default)(date.createdAt).format('LT');
...
socket.on('newLocationMessage', function (data) {
    var li = (0, _jquery2.default)('<li></li>'),
        a = (0, _jquery2.default)('<a target="_blank">My current location</a>'),
        formatedTime = (0, _moment2.default)(data.createdAt).format('LT');
